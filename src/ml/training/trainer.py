...
def preparar_dados(
    ...
    """Prepare Spark data for local model training.

    Args:
        df: Spark DataFrame containing text and target columns.
        target_col: Name of the target label column.

    Returns:
        Pandas DataFrame with cleaned text and labels.
    """
...
def balancear_dataset(
    ...
    """Balance the training dataset by limiting records per class.

    Args:
        pdf: Input Pandas DataFrame.
        target_col: Target label column.
        max_por_classe: Maximum records kept per class.
        min_por_classe: Minimum records required for a class.

    Returns:
        Balanced and shuffled Pandas DataFrame.
    """
...
def split_dataset(
    ...
    """Split a labeled dataset into train and test samples.

    Args:
        pdf: Input Pandas DataFrame.
        target_col: Target label column.
        test_size: Fraction used for the test sample.

    Returns:
        Train and test arrays generated by scikit-learn.
    """
